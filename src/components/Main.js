        ...
        <div className='flex flex-col font-title mt-20 md:mt-[160px] items-center'>
          ...
          <div className='w-full font-title flex flex-col gap-7'>
            <input 
              ...
              className="bg-primary-50 p-3 md:p-4 rounded-xl w-full text-gray-600 placeholder-gray-400 main-input focus:shadow-[0_0_20px_0_rgba(97,95,225,0.3)] focus:outline-[1px] focus:outline-primary-500"
            />
            <button 
              onClick={handleNextClick}
              className={`h-[50px] md:h-[60px] px-6 rounded-full text-base md:text-xl w-full font-400 ${url.includes('.') ? 'bg-primary-500 text-white font-600' : 'bg-gray-300 text-gray-400 cursor-not-allowed'}`}
